...
PATH_TO_FROZEN_GRAPH = 'output/exp52/frozen_inference_graph.pb'
...
PATH_IMAGES_DIR = 'test_images'
images_files = [ x for x in os.listdir(PATH_IMAGES_DIR) if x.endswith('.jpg')]
PATH_IMAGES_OUT_DIR = 'test_images/out'
